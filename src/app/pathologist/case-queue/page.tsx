          ...
          {rows.map((c: any, i: number) => {
            ...
            return (
              <Link key={c.id} href={`/pathologist/cases/${c.id}`} style={{
                ...
                <div style={{ width: 44, height: 44, borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, flexShrink: 0, background: urg.bg, border: `1px solid ${urg.color}` }}>
