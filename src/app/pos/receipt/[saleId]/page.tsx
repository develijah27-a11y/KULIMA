...
export default async function PosReceiptPage({
  ...
  const paymentLabel: Record<string, string> = { cash: 'Cash', wallet: 'AgriNova Wallet', mobile_money: 'Mobile Money' };
    ...
    <>
      ...
      <div className="receipt-wrap" style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 36 }}>
          <div>
            <p style={{ fontSize: 26, fontWeight: 900, color: '#15803d', margin: 0, letterSpacing: '-0.03em' }}>AGRINOVA</p>
        ...
        <div style={{ borderTop: '1px solid #f3f4f6', paddingTop: 20, textAlign: 'center' }}>
          <p style={{ fontSize: 11, color: '#9ca3af', margin: 0 }}>
            This receipt is generated by AgriNova Platform · Receipt #{receiptNo} · {new Date().getFullYear()}
          </p>
          <p style={{ fontSize: 11, color: '#9ca3af', margin: '4px 0 0' }}>
            Kampala, Uganda · agrinova-ug.vercel.app
          </p>
        </div>
      </div>
    </>
