...
export default async function GroupsDeliveriesPage() {
    ...
    <div className="max-w-2xl mx-auto space-y-5">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: C.muted }}>Request and track transport for your group's harvest</p>
        </div>
        <Link href="/groups/deliveries/new"
      ...
      {rows.length === 0 && (
        <div style={{ background: C.cardBg, borderRadius: 16, boxShadow: C.cardShadow, padding: '48px 24px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 13, color: C.muted, marginBottom: 20 }}>Move your group's harvest to market quickly and safely</p>
          <Link href="/groups/deliveries/new"
