  ...
  return (
    <>
      ...
      <div className="receipt-wrap" style={{
        position: 'relative', maxWidth: 680, margin: '0 auto', background: '#fff', borderRadius: 20,
        boxShadow: '0 4px 40px rgba(0,0,0,0.10)', padding: '40px 44px', overflow: 'hidden',
        fontFamily: "'Poppins', 'Inter', system-ui, sans-serif", color: '#111',
      }}>
        {/* Watermark — the real brand mark, faint and oversized, sitting
            behind every section rather than a separate decorative element,
            so it survives print/PDF export the same way the content does. */}
        <div style={{
