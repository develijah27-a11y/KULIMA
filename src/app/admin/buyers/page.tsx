  ...
  return (
    <div className="space-y-5 max-w-5xl mx-auto">
      <div>
        ...
        <p className="text-sm mt-0.5" style={{ color: C.muted }}>Registered buyers across the platform</p>
      </div>

      <Suspense fallback={
        <div className="space-y-2">
          {[1, 2, 3, 4, 5].map(i => <div key={i} className="dash-skeleton h-14 rounded-xl" />)}
        </div>
      }>
        <BuyersList />
      </Suspense>
