...
export default async function OfftakerDeliveriesPage() {
    ...
    <div className="max-w-2xl mx-auto space-y-5">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: C.muted }}>Request and track transport for your contracted volumes</p>
        </div>
        <Link href="/offtaker/deliveries/new"
      ...
      {rows.length === 0 && (
        <div style={{ background: C.cardBg, borderRadius: 16, boxShadow: C.cardShadow, padding: '48px 24px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 13, color: C.muted, marginBottom: 20 }}>Move contracted volumes quickly and safely</p>
          <Link href="/offtaker/deliveries/new"
