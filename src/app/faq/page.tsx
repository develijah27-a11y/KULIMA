...
export default function FaqPage() {
  return (
    <LegalPage title="Help & FAQ" updated="13 August 2026">
      ...
      <Faq q="How do deposits and withdrawals work?" a="Deposits and withdrawals are processed through PrimePay via MTN Mobile Money and Airtel Money. You top up or withdraw from your in-app wallet — Cropify never has access to, and never asks for, your mobile money PIN." />
      <Faq q="What happens if my withdrawal fails?" a="If a mobile money withdrawal fails on the network side, the funds stay in your Cropify wallet — they are not lost. Retry the withdrawal, and if it keeps failing, contact support with the transaction details so we can check with PrimePay on our end." />
